...
class Monitor extends Component {
    ...
    delOrder(product) {
        ...
        let findOrder = this.state.orders.find(order => order.product.id == product.product.id)
        let resultOrder = this.state.orders.filter(order => order.product.id != product.product.id)
